$(document).ready(function () {
    $( "form" ).submit(function( event ) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#chart').append( "<button class='btn btn-primary' id='chart-save'>Get Chart Image</button>");
            },
            error: function (data) {
    ...
    $('#chart').on('click', '#chart-save', function(){
      svgAsDataUri($('#chart svg')[0], null, function(uri) {
        ...
        $('#chart-image').append("<button class='btn btn-primary' id='image-save'>Save Image</button>");
      });
    });
